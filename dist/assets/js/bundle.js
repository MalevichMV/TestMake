...
/* harmony export */ });
function accordion() {
  var accordionHeader = document.querySelector('.UI__accordion-header');
  var accordionBody = document.querySelector('.UI__accordion-body');
  var accordion = document.querySelector('.UI__accordion-wrapper');
...
/* harmony export */ });
function check_btns() {
  var parentCheckbox = document.querySelector('.UI__check_button'),
...
function dropdownList() {
  var header = document.querySelector('.UI__drop-downList-select-header'),
...
function modal() {
  ...
  modal.addEventListener('click', function (e) {
    if (e.target.className === 'modal__close') closemodal();
  });
  ...
  window.addEventListener("scroll", function () {
    ...
    sections.forEach(function (current) {
      ...
      if (scroll > sectionTop && scroll <= sectionTop + sectionHeight) {
        document.querySelector(".navigation a[href*='".concat(sectionId, "']")).classList.add("active_link");
      } else {
        document.querySelector(".navigation a[href*='".concat(sectionId, "']")).classList.remove("active_link");
      }
    });
  });
}
...
/* harmony export */ });
function tabs() {
  var tabs = document.querySelectorAll('.typography__tabs-item'),
...
/* harmony export */ });
function textField() {
  var input = document.querySelector('.UI__textField-input'),
...
/* harmony import */ var _scss_base_scss__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../scss/base.scss */ "./src/scss/base.scss");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_textField__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_modules_dropdownList__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_modules_check_btns__WEBPACK_IMPORTED_MODULE_3__["default"])();
